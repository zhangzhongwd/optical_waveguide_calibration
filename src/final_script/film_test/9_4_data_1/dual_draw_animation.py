...
def update(i):
    ...
    plt.text(0.2,6,'distance is %.2f mm'%(i*2))
    # return line, ax
...
if __name__ == '__main__':
    ...
    for i in range(plot_number):
        ...
        myfile_1 = open('/home/zhong/Sensor/src/final_script/film_test/9_4_data_1/' + (i * 1000).__str__() + '.txt')
        myfile_2 = open('/home/zhong/Sensor/src/final_script/film_test/9_4_data_1/force/' + (i).__str__() + '.txt')
        force_z = []
        voltage_1 = []
        voltage_2 = []
