...
time=[]
for i in range(10):
	fname='/home/zhong/Sensor/src/final_script/film_test/9_4_data_3/'+(i*1000).__str__()+'.txt'
...
myfile=open('/home/zhong/Sensor/src/final_script/film_test/9_4_data_3/force/original.txt')
for i in range(5568):
	a=myfile.readline()
	a=a.split()
	force.append(a[2])
...
for i in range(10):
	force_temp=[]
	fout=open('/home/zhong/Sensor/src/final_script/film_test/9_4_data_3/force/'+(i).__str__()+'.txt','a+')
	for j in range(50):
