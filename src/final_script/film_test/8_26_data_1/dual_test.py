...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	msg=Waveguide.create_motor_drive_msg(2,True,3700)
	fy=fy+3700
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(4)
	msg=Waveguide.create_motor_drive_msg(3,True,14800)
	fz=fz+14800
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(16)
	...
	start=time.time()
	for i in range(10):
		msg=Waveguide.create_motor_drive_msg(1,True,1500)
		fx=fx+1500
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(3)

		fout=open('/home/zhong/Sensor/src/final_script/film_test/8_26_data_1/'+(i*1500).__str__()+'.txt','a+')
		...
		msg=Waveguide.create_motor_drive_msg(3,False,550)
		fz=fz-550
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(1)				
