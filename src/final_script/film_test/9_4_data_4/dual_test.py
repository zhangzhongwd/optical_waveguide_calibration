...
if __name__=='__main__':
	...
	for i in range(20):
		...
		fout=open('/home/zhong/Sensor/src/final_script/film_test/9_4_data_4/'+(i*1000).__str__()+'.txt','a+')
		...
		for j in range(50):
			msg=Waveguide.create_motor_drive_msg(3,True,4)
			fz=fz+4
			Waveguide.publish_motor_drive(msg)
			rospy.sleep(1)
			fout.write(str(round(time.time()-start,2)))  
		...
		msg=Waveguide.create_motor_drive_msg(3,False,250)
		fz=fz-250
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(5)				
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(4)
	msg=Waveguide.create_motor_drive_msg(1,True,8000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(9)
