...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	msg=Waveguide.create_motor_drive_msg(2,True,2450)
	fy=fy+2450
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(3)
	...
	for i in range(10):
		...
		fout=open('/home/zhong/Sensor/src/final_script/film_test/9_5_data_2/'+(i*1000).__str__()+'.txt','a+')
		...
		msg=Waveguide.create_motor_drive_msg(3,True,470)
		fz=fz+470
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(1)
		...
		msg=Waveguide.create_motor_drive_msg(3,False,770)
		fz=fz-770
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(10)				
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(15)
	msg=Waveguide.create_motor_drive_msg(2,False,2000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(4)
