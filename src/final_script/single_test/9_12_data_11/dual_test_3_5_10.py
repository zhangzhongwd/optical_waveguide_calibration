...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(2.5)
	msg=Waveguide.create_motor_drive_msg(3,True,9600)
	fz=fz+9600
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(11)
	...
	for i in range(11):
		...
		fout=open('/home/zhong/Sensor/src/final_script/single_test/9_12_data_11/'+(i*1000).__str__()+'.txt','a+')
		for j in range(150):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(3)
	msg=Waveguide.create_motor_drive_msg(1,False,9400)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
