...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(3)
	msg=Waveguide.create_motor_drive_msg(2,False,600)
	fy=fy-600
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(1.5)
	msg=Waveguide.create_motor_drive_msg(3,True,9150)
	fz=fz+9150
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	...
	for i in range(21):
		...
		fout=open('/home/zhong/Sensor/src/final_script/single_test/7_10_data_2_2nd/'+(i*500).__str__()+'.txt','a+')
		for j in range(200):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(9)
	msg=Waveguide.create_motor_drive_msg(2,True,1500)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(2)
