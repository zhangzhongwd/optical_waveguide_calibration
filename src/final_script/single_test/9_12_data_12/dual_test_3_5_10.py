...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(2.5)
	msg=Waveguide.create_motor_drive_msg(3,True,9900)
	fz=fz+9900
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(11)
	...
	for i in range(1000):
		...
		fout=open('/home/zhong/Sensor/src/final_script/single_test/9_12_data_12/'+(i).__str__()+'.txt','a+')
		for j in range(15):
			msg=Waveguide.create_motor_drive_msg(3,True,100)
			fz=fz+100
			Waveguide.publish_motor_drive(msg)
			rospy.sleep(0.5)  
	...
	msg=Waveguide.create_motor_drive_msg(3,False,9000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	msg=Waveguide.create_motor_drive_msg(2,True,2000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(3)
	msg=Waveguide.create_motor_drive_msg(1,False,3000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(4)
