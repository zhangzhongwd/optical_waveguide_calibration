...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(4.5)
	msg=Waveguide.create_motor_drive_msg(2,True,5400)
	fy=fy+5400
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(6)
	msg=Waveguide.create_motor_drive_msg(3,True,9800)
	fz=fz+9800
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(11)
	...
	for i in range(11):
		...
		fout=open('/home/zhong/Sensor/src/final_script/single_test/9_12_data_8_2nd/'+(i*1000).__str__()+'.txt','a+')
		for j in range(150):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(9)
	msg=Waveguide.create_motor_drive_msg(2,True,5000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(6)
