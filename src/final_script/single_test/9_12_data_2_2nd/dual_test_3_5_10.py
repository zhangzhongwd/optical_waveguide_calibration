...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(6)
	msg=Waveguide.create_motor_drive_msg(3,True,9500)
	fz=fz+9500
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	...
	for i in range(11):
		...
		fout=open('/home/zhong/Sensor/src/final_script/single_test/9_12_data_2_2nd/'+(i*1000).__str__()+'.txt','a+')
		for j in range(150):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(9)
	msg=Waveguide.create_motor_drive_msg(2,False,4000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(5)
