...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(2.5)
	msg=Waveguide.create_motor_drive_msg(2,True,10000)
	fy=fy+10000
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(11)
	msg=Waveguide.create_motor_drive_msg(3,True,7200)
	fz=fz+7200
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)

	msg=Waveguide.create_motor_drive_msg(1,False,8750)
	fx=fx-8750
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	...
	for i in range(36):
		...
		fout=open('/home/zhong/Sensor/src/final_script/dual_test/7_7_data_1_3rd/'+(i*500).__str__()+'.txt','a+')
		for j in range(200):
		...
		msg=Waveguide.create_motor_drive_msg(3,False,2000)
		fz=fz-2000
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(3)	

		msg=Waveguide.create_motor_drive_msg(1,True,500)
		fx=fx+500
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(1)

	msg=Waveguide.create_motor_drive_msg(3,False,7000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	msg=Waveguide.create_motor_drive_msg(2,False,9000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	msg=Waveguide.create_motor_drive_msg(1,False,11000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(12)
