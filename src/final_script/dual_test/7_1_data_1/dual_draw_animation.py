...
def update(i):
    ...
    plt.text(10,5,'distance is %.2f mm'%(i*0.2))
    # return line, ax
...
if __name__ == '__main__':
    ...
    for i in range(plot_number):
        print i
        myfile = open('/home/zhong/Sensor/src/final_script/dual_test/7_1_data_1/' + (i * 100).__str__() + '.txt')
        force_z = []
        voltage_1 = []
        voltage_2 = []
        for i in range(200):
    ...
    anim = FuncAnimation(fig, update, frames=175, interval=50)
