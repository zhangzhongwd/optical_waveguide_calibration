...
if __name__=='__main__':
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(2.5)
	msg=Waveguide.create_motor_drive_msg(2,True,13700)
	fy=fy+13200
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(14)
	msg=Waveguide.create_motor_drive_msg(3,True,7400)
	fz=fz+7400
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	...
	for i in range(200):
		...
		fout=open('/home/zhong/Sensor/src/final_script/dual_test/6_20_data_3/'+(i*50).__str__()+'.txt','a+')
		for j in range(300):
		...
		msg=Waveguide.create_motor_drive_msg(3,False,3000)
		fz=fz-3000
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(3.5)				

	msg=Waveguide.create_motor_drive_msg(3,False,7400)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
