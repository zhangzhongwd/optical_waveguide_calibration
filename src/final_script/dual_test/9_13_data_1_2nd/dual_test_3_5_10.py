...
if __name__=='__main__':
	...
	fx,fy,fz=0,0,0
	msg=Waveguide.create_motor_drive_msg(1,True,7000)
	fx=fx+7000
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	msg=Waveguide.create_motor_drive_msg(2,True,13250)
	fy=fy+13250
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(14)
	msg=Waveguide.create_motor_drive_msg(3,True,7600)
	fz=fz+7600
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8.5)
	...
	for i in range(11):
		...
		fout=open('/home/zhong/Sensor/src/final_script/dual_test/9_13_data_1_2nd/'+(i*1000).__str__()+'.txt','a+')
		for j in range(200):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(8)
	msg=Waveguide.create_motor_drive_msg(2,False,13000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(14)
