...
if __name__ == '__main__':
    ...
    for i in range(plot_number):
        print i
        myfile = open('/home/zhong/Sensor/src/final_script/dual_test/9_13_data_1/' + (i * 1000).__str__() + '.txt')
        force_z = []
        voltage_1 = []
        voltage_2 = []
        for i in range(200):
        ...
        voltage_1 = [i-71.0 for i in voltage_1]
        voltage_2 = [i-80.0 for i in voltage_2]
