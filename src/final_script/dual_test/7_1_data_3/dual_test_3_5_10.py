...
if __name__=='__main__':
	...
	msg=Waveguide.create_motor_drive_msg(1,False,10000)
	fx=fx-10000
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(11)
	...
	for i in range(200):
		msg=Waveguide.create_motor_drive_msg(1,True,100)
		fx=fx+100
		Waveguide.publish_motor_drive(msg)
		rospy.sleep(1)

		fout=open('/home/zhong/Sensor/src/final_script/dual_test/7_1_data_3/'+(i*100).__str__()+'.txt','a+')
		for j in range(200):
	...
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(10)
	msg=Waveguide.create_motor_drive_msg(1,False,12000)
	Waveguide.publish_motor_drive(msg)
	rospy.sleep(13)
