...
if __name__ == '__main__':
    ...
    for i in range(plot_number):
        print i
        myfile = open('/home/zhong/Sensor/src/final_script/dual_test/7_7_data_2_2nd/' + (i * 500).__str__() + '.txt')
        force_z = []
        voltage_1 = []
        voltage_2 = []
        for i in range(200):
        ...
        voltage_1 = [i-2200.0 for i in voltage_1]
        voltage_2 = [i-1300.0 for i in voltage_2]
